...
Some of the method use Authentification by a special service like [fnbr.co](https://fnbr.co/account) or [Fortnite Tracker](https://fortnitetracker.com/site-api). Make sure you have the api key for these service if you want to use their service.

  

### Create a Client

You're not obliged to create a client if you doesn't want to use [fnbr.co](https://fnbr.co|newtab=true) and [Fortnite Tracker](https://fortnitetracker.com/site-api) api. Make sure you have insert your credentials in the client.
...
fortnite.shop("en")//can be en or es
.then(shop  =>  console.log(shop))
.catch(err  =>  console.error(err))
```
...
[![Discord Bots](https://discordbots.org/api/widget/509106823677083667.svg)](https://discordbots.org/bot/509106823677083667)